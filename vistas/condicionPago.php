...
else
{
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="condicion_pago" id="condicion_pago" required>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                </div>
    ...
    require 'footer.php';
    ?>
    <script type="text/javascript" src="scripts/condicionPago.js"></script>
