...
else
{
                ...
                <div class="box box-danger" id="formularioRegistros">
                    <div class="box-body">
                        <!--CONTENIDO -->
                                ...
                                <button type="button" class="btn btn-primary" name="btnImpreso" id="btnImpreso" onclick="ccfImpreso();">CCF Impreso</button>&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="formularioDetalle" id="formularioDetalle" method="POST">
                                    ...
                                    <input type="hidden" name="id_ccf" id="id_ccf">
                                    <div class="row">
                                        <div class="col-md-6">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="formularioAnular" id="formularioAnular" method="POST">
                                    <input type="hidden" name="id_ccf_anular" id="id_ccf_anular">
                                    <div class="row">
                                        <div class="col-md-12">
    ...
    require 'footer.php';
    ?>
    <script type="text/javascript" src="scripts/ccf.js"></script>
